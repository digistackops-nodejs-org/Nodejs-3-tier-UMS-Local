  ...
  return (
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          <img src={logo} alt="DigiStack logo" className="logo" />
          <div>
            <h1 className="brand-title">DigiStack</h1>
            <p className="nav-subtitle">DigiStack UMS</p>
          </div>
        </div>
      </header>
      <AnimatedBanner message="Welcome to DigiStack Solutions🚀" />
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} DigiStack Solutions. All rights reserved.</p>
      </footer>
